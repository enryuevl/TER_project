...
def process_sections(img):
    ...
    sections = {
        "Section 1": resized[461:613, 579:776],
        "Section 2": resized[631:784, 579:776],
        "Section 3": resized[800:964, 579:776],
        "Section 4": resized[981:1146, 579:776],
    }
    ...
    for sec_name, sec_img in sections.items():
        ...
        # Draw detected circles and scores
        unique_cells = {}
        circle_assignments = []
        ...
        for (row, col), (x, y, area) in unique_cells.items():
            ...
            text = f"Score: {score}"
            cv2.putText(sec_img, text, (x+20, y+5),
