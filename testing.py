...
def process_sections(img):
    im = cv2.imread("C:/Users/paula/Downloads/test.jpg")
    
    resized = cv2.resize(im, (850, 1550))
    cv2.imshow("Resized Image", resized)

    # Define sections dictionary; each section is processed independently.
    sections = {
        "Section 1": resized[534:664, 598:798],
        "Section 2": resized[687:838, 598:798],
        "Section 3": resized[857:1023, 598:798],
        "Section 4": resized[1047:1209, 598:798],
    }
...
image = cv2.imread("C:/Users/paula/Downloads/test.jpg")
process_sections(image)
