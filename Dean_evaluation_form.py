...
# NEW: reuse the shared summary module
...
class DeanEvaluationForm:
    def __init__(self, master, processed_results, results_file=None):
        ...
        # Always point to Documents\MyWork\results.pkl
        ...
        # NEW: create a single summary controller (shared across buttons)
    ...
    def _build_ui(self):
        ...
        # ----- Summary buttons (NOW using the module) -----
        btn_bar = CTkFrame(container, fg_color="transparent")
        btn_bar.pack(pady=(0, 10))

        CTkButton(btn_bar, text="View Summary",
                  fg_color="#AC5353", hover_color="#8B1D18",
                  text_color="#FFFFFF", font=("Roboto", 14, "bold"),
                  corner_radius=8, command=self._open_summary_for_current)\
